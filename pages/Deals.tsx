    ...
    <div className="flex flex-col h-full overflow-hidden">
      <div className="p-8 pb-4 shrink-0 flex items-end justify-between border-b border-border-light bg-white">
        ...
        <div className="flex gap-3">
          ...
          <button className="bg-primary text-white px-5 py-2.5 rounded-xl text-sm font-bold shadow-lg shadow-primary/20 hover:scale-[1.02] transition-all flex items-center gap-2">
      ...
      <div className="flex-1 overflow-x-auto p-8 custom-scrollbar">
        <div className="flex gap-6 h-full min-h-0">
          {stages.map((stage) => {
            ...
            return (
              <div key={stage.id} className="w-80 flex flex-col gap-4 flex-shrink-0">
                ...
                <div className="flex-1 space-y-4 overflow-y-auto pr-1 custom-scrollbar">
                  {stageDeals.map((deal) => (
                    <div key={deal.id} className="bg-white p-5 rounded-2xl border border-border-light shadow-sm hover:border-primary/50 hover:shadow-md transition-all cursor-pointer group">
