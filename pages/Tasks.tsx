          ...
          <table className="w-full text-left">
            ...
            <tbody className="divide-y divide-border-light">
              {processedTasks.map((task) => (
                <tr 
                  key={task.id} 
                  className={`hover:bg-slate-50/50 transition-all group relative border-l-4 ${
                    task.priority === 'High' 
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    <div className="flex flex-col">
                      <p className={`text-sm font-bold ${task.dueDate.includes('Today') ? 'text-red-600' : 'text-slate-600'}`}>
                        {task.dueDate}
                      </p>
                    </div>
                  </td>
